...
#include <memory>
#include "../../../gallery-desktop/PictureDelegate.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'PictureDelegate.h' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject PictureDelegate::staticMetaObject = { {
    QMetaObject::SuperData::link<QStyledItemDelegate::staticMetaObject>(),
    qt_meta_stringdata_PictureDelegate.data,
    qt_meta_data_PictureDelegate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
