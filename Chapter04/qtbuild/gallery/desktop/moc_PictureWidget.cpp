...
#include <memory>
#include "../../../gallery-desktop/PictureWidget.h"
...
QT_MOC_LITERAL(1, 14, 13), // "backToGallery"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 13), // "deletePicture"
QT_MOC_LITERAL(4, 43, 11), // "loadPicture"
QT_MOC_LITERAL(5, 55, 14), // "QItemSelection"
QT_MOC_LITERAL(6, 70, 8) // "selected"

    },
    "PictureWidget\0backToGallery\0\0deletePicture\0"
    "loadPicture\0QItemSelection\0selected"
};
...
void PictureWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->deletePicture(); break;
        case 2: _t->loadPicture((*reinterpret_cast< const QItemSelection(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (PictureWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PictureWidget::backToGallery)) {
                *result = 0;
                return;
            }
        }
