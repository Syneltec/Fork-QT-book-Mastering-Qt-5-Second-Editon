...
QT_MOC_LITERAL(1, 13, 15), // "numberPopulated"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 6), // "number"
QT_MOC_LITERAL(4, 37, 22) // "deletePicturesForAlbum"

    },
    "PictureModel\0numberPopulated\0\0number\0"
...
void PictureModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->deletePicturesForAlbum(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (PictureModel::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PictureModel::numberPopulated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PictureModel::numberPopulated(int _t1)
{
